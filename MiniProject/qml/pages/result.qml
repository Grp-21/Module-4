...
Item {
    ...
    Rectangle {
        ...
        CircularProgressBar{
            ...
            objectName: "foo_object2"
            textColor: "#55aaff"
            strokeBgWidth: 5
            value:{backend.sendConfidence(4)}
            textShowValue: true
        ...
        Rectangle {
            ...
            TextEdit {
                ...
                color: "#f1f2f4"
                text: {
                    backend.sendClass("hello")
                    //qsTr("Probability of Alteration : Fake")
                }
        ...
        Connections{
            ...
            function onSetClass(name){
                textEdit.text = name
            }

            function onSetConfidence(confi){
                bar.value = confi
            }
            function onSetLocPercen(percen){
                bar1.value = percen
            }
